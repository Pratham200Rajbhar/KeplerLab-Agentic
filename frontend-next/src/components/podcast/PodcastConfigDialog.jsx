  ...
  return (
    <Modal onClose={onClose} maxWidth="md">
      <div className="flex items-center justify-between px-5 py-4 border-b border-(--border)">
        <h3 className="text-base font-semibold text-(--text-primary)">Podcast Settings</h3>
      ...
      <div className="flex items-center justify-end gap-2 px-5 py-4 border-t border-(--border)">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg bg-(--accent) text-white hover:bg-(--accent-light) transition-colors disabled:opacity-40"
        >
          {loading ? (
            <>
