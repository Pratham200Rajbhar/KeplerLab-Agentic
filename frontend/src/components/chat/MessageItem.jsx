              ...
              <div className="flex items-center gap-0.5 mt-1 opacity-0 group-hover:opacity-100 transition-opacity duration-150">
                {onEdit && (
                  <button
                    ...
                    title="Edit message"
                    className="inline-flex items-center justify-center w-7 h-7 rounded-lg text-text-muted hover:text-text-secondary hover:bg-surface-overlay transition-colors"
                  >
                ...
                {onDelete && (
                  <button
                    ...
                    className="inline-flex items-center justify-center w-7 h-7 rounded-lg text-text-muted hover:text-danger hover:bg-danger/10 transition-colors"
                  >
